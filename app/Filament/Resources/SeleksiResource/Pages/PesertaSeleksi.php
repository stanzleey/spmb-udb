...
class PesertaSeleksi extends Page implements Tables\Contracts\HasTable
{
    ...
    protected function getActions(): array
    {
        ...
        return ViewFormulirPeserta::select("no_daftar",DB::raw("CONCAT(no_daftar,' - ',nama) as label") )->where('nama', 'like',"%".$search."%")->whereNull("id_seleksi")->limit(5)->pluck('label', 'no_daftar');
        })
        ->required(),
        ])
